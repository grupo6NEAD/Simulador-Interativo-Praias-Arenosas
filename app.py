...
def classificar_praia(total):
    if total <= 10:
        return "Praia Dissipativa"
    elif total <= 15:
        return "Praia Intermediária Plana"
    elif total <= 20:
        return "Praia Intermediária Com Barra e Escoamento"
    else:
        return "Praia Refletiva"
